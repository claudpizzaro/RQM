    ...
    return (
        <section className='row footer'>
            <Row className="col-md-11 mx-auto">
                ...
                <FooterCol key="3" menuItems={ourServices} title="Areas of Interest"/>
                <FooterCol key="4" menuItems={otherLinks} title="OTHER LINKS"/>
            </Row>
            <p className="copyRight">Copyright &copy; 2022 <span className="fHighlight">Requiem</span>. All rights reserved.</p>
        </section>
    );
};
